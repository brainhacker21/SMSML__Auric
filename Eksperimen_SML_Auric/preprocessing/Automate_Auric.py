...
if __name__ == "__main__":
    ...
    input_csv_path = "Eksperimen_SML_Auric/dataset_raw/StudentsPerformance_raw.csv"
    output_csv_path = "Eksperimen_SML_Auric/preprocessing/dataset_preprocessed/processed_student_automated.csv"
